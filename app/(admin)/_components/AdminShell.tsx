...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-axon-bg text-white">
      ...
      {/* ── Área principal ── */}
      {/* CORREÇÃO: overflow-visible no main para o dropdown não ser cortado */}
      <main className="flex-1 flex flex-col h-screen min-w-0">

        {/* Header — overflow visible para o dropdown escapar */}
        <header className="h-16 bg-axon-panel/80 backdrop-blur-md border-b border-axon-border flex items-center justify-between px-8 sticky top-0 z-10 overflow-visible">
