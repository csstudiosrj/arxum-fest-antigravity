      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-axon-border">
          {isSidebarOpen ? (
            <span className="text-xl font-bold tracking-wider truncate px-2">
              AXON{" "}
              <span className="text-axon-green font-light">Fest</span>
            </span>
          ) : (
        ...
        {isSidebarOpen && (
          <div className="px-3 pb-4 border-t border-axon-border pt-3">
            <Link
              href="/configuracoes"
              className="flex items-center gap-3 px-3 py-2 rounded-md text-gray-400 hover:text-white hover:bg-white/5 transition-colors text-sm"
            >
