...
export default function ClientShell({ children }: { children: React.ReactNode }) {
  ...
  // Lista de rotas para renderizar o menu de forma limpa e escalável
  const navLinks =[
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-axon-border">
          {isSidebarOpen ? (
            ...
            <span className="text-xl font-bold tracking-wider mx-auto text-axon-green">
              AX
            </span>
          )}
        </div>
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <header className="h-16 bg-axon-panel/80 backdrop-blur-md border-b border-axon-border flex items-center justify-between px-8 sticky top-0 z-10">
          ...
          <div className="relative">
            ...
            >
              <div className="w-9 h-9 rounded-full bg-axon-border flex items-center justify-center text-axon-green font-bold text-sm">
                AX
              </div>
            ...
            {isUserMenuOpen && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-axon-panel border border-axon-border rounded-xl shadow-2xl z-50 py-2 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <a href="#" className="flex items-center gap-3 px-4 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-red-400/10 transition-colors">
